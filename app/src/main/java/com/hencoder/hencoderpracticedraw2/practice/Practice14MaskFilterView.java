...
public class Practice14MaskFilterView extends View {
  ...
  MaskFilter innerBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
  MaskFilter outerBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
  MaskFilter solidBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
